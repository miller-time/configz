-- My xmonad.hs. Adapted from the example config as you can tell.
--
...
--
myWorkspaces    = ["web","mail","term","4","5","6","7","8","9"]
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    -- WindowBringer bindings.
    , ((modMask .|. shiftMask, xK_g     ), gotoMenu)
    , ((modMask .|. shiftMask, xK_b     ), bringMenu)
 
    -- Battery meter spawner binding.
    , ((modMask              , xK_b     ), spawn "dzen_batt.sh")
    ]
    ++
...
--
myLayout = avoidStruts $ (smartBorders Full ||| tiled ||| myTabbed)
  where
